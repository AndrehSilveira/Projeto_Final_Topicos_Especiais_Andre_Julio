...
from RhApp.serializers import DepartamentoSerializer, EmpregadoSerializer, UsuarioSerializer
...
def departamentoApi(request, id = 0):
  if request.method == 'GET':
    ...
    departamento.delete()
    return JsonResponse("Departamento excluido com sucesso.", safe=False)
...
def empregadoApi(request, id = 0):
  if request.method == 'GET':
    ...
    empregado.delete()
    return JsonResponse("Empregado excluido com sucesso.", safe=False)
...
def usuarioApi(request, id = 0):
  if request.method == 'GET':
    ...
    usuario.delete()
    return JsonResponse("Usuário excluido com sucesso.", safe=False)
